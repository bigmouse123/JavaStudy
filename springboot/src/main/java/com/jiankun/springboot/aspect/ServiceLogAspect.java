package com.jiankun.springboot.aspect;

import com.jiankun.springboot.service.impl.AdminServiceImpl;
...
public class ServiceLogAspect {
    ...
    @Pointcut(value = "execution(* com.jiankun.springboot.service.impl.*.*(..))")
    public void point() {
    }
